...
<body>
	...
	*/
	...
	if(is_resource($Dosya)){
		echo '$Deger adındaki değişkenin içeriği dosya bir resource (kaynak) içeriktir.';
	}else{
		echo '$Deger adındaki değişkenin içeriği dosya bir resource (kaynak) içerik değildir.';
	}
