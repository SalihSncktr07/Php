...
<body>
	...
	*/
	...
	if(is_a($SinifBir, "AAA")){
		echo '$SinifBir adındaki değişken AAA adındaki sınıfın nesnel örneğidir.';
	}else{
		echo '$SinifBir adındaki değişken AAA adındaki sınıfın nesnel örneği değildir.';
	}
