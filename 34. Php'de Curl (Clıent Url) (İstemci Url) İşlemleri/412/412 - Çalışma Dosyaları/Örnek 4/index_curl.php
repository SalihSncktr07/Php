...
<body>
	...
	*/
	...
	curl_setopt_array($Oturum, [
		...
		CURLOPT_POSTFIELDS =>  [
			"KullaniciAdi" => "Volkan",
			"KullaniciSifre" => "12345678"
		],
		CURLOPT_COOKIE =>  "Kullanici=Volkan",
	...
	$OturumIki	=	curl_init();
		curl_setopt_array($OturumIki, [
			CURLOPT_URL => "http://localhost/ExtraEgitim/KontrolluBirinciSayfa.php",
			CURLOPT_RETURNTRANSFER => true,
			CURLOPT_COOKIEFILE => __DIR__ . "/cerez.txt"
	]);
	...
	$OturumUc	=	curl_init();
		curl_setopt_array($OturumUc, [
			CURLOPT_URL => "http://localhost/ExtraEgitim/KontrolluIkinciSayfa.php",
			CURLOPT_RETURNTRANSFER => true,
			CURLOPT_COOKIEFILE => __DIR__ . "/cerez.txt"
	]);
