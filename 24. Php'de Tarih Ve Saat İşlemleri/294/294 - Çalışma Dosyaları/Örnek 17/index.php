...
<body>
	...
	*/
	...
	$GunBatimi		=	date_sunset($Zamandamgasi, SUNFUNCS_RET_TIMESTAMP, 39.913627, 32.850879); // T.B.M.M. Enlem ve Boylam Değerleri
	
	echo "Gün batımı : " . $GunBatimi . "<br />";
	
	echo "Gün batımı : " . date("d.m.Y H.i.s", ($GunBatimi - 3600));
