...
<body>
	...
	*/
	...
	echo "Bugünün Zaman Damgası : " . $Zamandamgasi . "<br />";
	
	$GunDogumu		=	date_sunrise($Zamandamgasi, SUNFUNCS_RET_TIMESTAMP, 39.913627, 32.850879); // T.B.M.M. Enlem ve Boylam Değerleri
	
	echo "Gün doğumu : " . $GunDogumu . "<br />";
	
	echo "Gün doğumu : " . date("d.m.Y H.i.s", ($GunDogumu - 3600));
