...
<body>
	...
	*/
	...
	$Deger	=	checkdate(2, 30, 1980); // 1. Değer : Ay (O'sız), 2. Değer : Gün (O'sız), 3. Değer : Yıl
	
	if($Deger==1){
		echo "Girilen Tarih Değeri (2.30.1980) Geçerlidir.";
	}else{
		echo "Girilen Tarih Değeri (2.30.1980) Geçerli Değildir.";
	}
