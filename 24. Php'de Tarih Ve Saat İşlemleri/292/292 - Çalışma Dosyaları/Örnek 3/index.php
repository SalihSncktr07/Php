...
<body>
	...
	*/
	...
	$Formatla	=	$Islem->format("%days"); // HATA : $days değeri bu şekilde alınmaz çünkü sanki %d gibi yazılmış kabul edilir sonuna ays eklenir.
	
	echo "08-12-1980 ile 05-07-1978 arasındaki gün farkı : " . $Formatla;
