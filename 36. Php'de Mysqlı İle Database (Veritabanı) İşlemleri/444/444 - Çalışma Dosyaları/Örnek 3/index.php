...
<body>
	...
	*/
	...
	$Ekle	=	$VeritabaniBaglantisi->query("INSERT INTO uyeler (adisoyadi, emailadresi, sifre, telefon, yas, cinsiyet, sehir) values ('Esra Deneme', 'tarik@extraegitim.com', '72528267', '05410000000', '47', 'Kadın', 'Hatay')");
		if($Ekle){
