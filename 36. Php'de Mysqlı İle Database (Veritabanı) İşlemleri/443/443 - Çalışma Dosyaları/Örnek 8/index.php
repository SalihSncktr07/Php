...
<body>
	...
	*/
	...
	$Sorgu		=	mysqli_query($VeritabaniBaglantisi, "SELECT sehir, MIN(siparistoplamtutarlari) AS MinimumTutar, MAX(siparistoplamtutarlari) AS MaksimumTutar, SUM(siparistoplamtutarlari) AS ToplamTutar FROM kayitlar GROUP BY sehir");
		if($Sorgu){
