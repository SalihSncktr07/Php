...
<body>
	...
	*/
	...
	$Sorgu	=	$VeritabaniBaglantisi->query("SELECT COUNT(id) AS ToplamSatir, MIN(siteyegirissayisi) AS MinimumSiteyeGirisSayisi, MAX(siteyegirissayisi) AS MakismumSiteyeGirisSayisi, AVG(yas) AS YasOrtalamasi, SUM(siparistoplamtutarlari) AS ToplamSiparislerTutari FROM kayitlar");
		if($Sorgu){
