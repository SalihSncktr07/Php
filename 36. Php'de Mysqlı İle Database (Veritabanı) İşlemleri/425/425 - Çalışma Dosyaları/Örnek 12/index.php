...
<body>
	...
	*/
	...
	$Sorgu	=	mysqli_query($VeritabaniBaglantisi, "CREATE TABLE volkanalakent.yenitablo LIKE extraegitim.deneme");
		if($Sorgu){
			echo "Tablo Oluşturuldu<br />";
			$SorguIki	=	mysqli_query($VeritabaniBaglantisi, "INSERT INTO volkanalakent.yenitablo SELECT * FROM extraegitim.deneme");
				if($SorguIki){
