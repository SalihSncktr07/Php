...
<body>
	...
	*/
	...
	$Sorgu	=	$VeritabaniBaglantisi->query("CREATE TABLE volkanalakent.yenitablo LIKE extraegitim.deneme");
		if($Sorgu){
			echo "Tablo Oluşturuldu<br />";
			$SorguIki	=	$VeritabaniBaglantisi->query("INSERT INTO volkanalakent.yenitablo SELECT * FROM extraegitim.deneme");
				if($SorguIki){
