...
<body>
	...
	*/
	...
	$Sorgu		=	mysqli_query($VeritabaniBaglantisi, "SELECT uyeler.id AS UyeID, uyeler.adisoyadi AS UyeAdSoyad, uyeler.yas AS UyeYas, uyeler.sehir AS UyeSehir, istatistikler.id AS IstatistikID, istatistikler.uyeid AS IstatistikUyeID, istatistikler.siteyegirissayisi AS IstatistikGirisSayisi, istatistikler.siparissayisi AS IstatistikSiparisSayisi FROM uyeler INNER JOIN istatistikler ON uyeler.id = istatistikler.uyeid");
		if($Sorgu){
