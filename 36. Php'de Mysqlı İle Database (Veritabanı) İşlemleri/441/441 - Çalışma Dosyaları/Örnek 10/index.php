...
<body>
	...
	*/
	...
	$Sorgu		=	$VeritabaniBaglantisi->query("SELECT uyeler.id AS UyeID, uyeler.adisoyadi AS UyeAdSoyad, uyeler.yas AS UyeYas, uyeler.sehir AS UyeSehir, istatistikler.id AS IstatistikID, istatistikler.uyeid AS IstatistikUyeID, istatistikler.siteyegirissayisi AS IstatistikGirisSayisi, istatistikler.siparissayisi AS IstatistikSiparisSayisi, sipariler.id AS SiparisID, sipariler.uyeid AS SiparisUyeID, sipariler.urunadi AS SiparisUrunAdi, sipariler.urunfiyati AS SiparisUrunFiyati FROM uyeler INNER JOIN istatistikler ON uyeler.id = istatistikler.uyeid INNER JOIN sipariler ON uyeler.id = sipariler.uyeid");
		if($Sorgu){
