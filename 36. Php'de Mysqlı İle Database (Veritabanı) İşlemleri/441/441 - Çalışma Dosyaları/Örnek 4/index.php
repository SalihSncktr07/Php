...
<body>
	...
	*/
	...
	$Sorgu		=	mysqli_query($VeritabaniBaglantisi, "SELECT * FROM uyeler INNER JOIN istatistikler ON uyeler.id = istatistikler.uyeid INNER JOIN sipariler ON uyeler.id = sipariler.uyeid");
		if($Sorgu){
