...
<body>
	...
	*/
	...
	$Sorgu		=	mysqli_query($VeritabaniBaglantisi, "SELECT uyeler.id AS UyeID, uyeler.adisoyadi AS UyeAdSoyad, uyeler.yas AS UyeYas, uyeler.sehir AS UyeSehir, sipariler.urunadi AS SiparislerUrunAdi, sipariler.urunfiyati AS SiparislerUrunFiyati FROM uyeler LEFT JOIN sipariler ON uyeler.id = sipariler.uyeid");
		if($Sorgu){
