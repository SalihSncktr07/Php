...
<body>
	...
	*/
	...
	interface Deneme{
		...
		public function Tanim($ParametreIcerigi);  // Hata kodu döndürür, çünkü soyut arayüz sınıfı içerisinde bulunan metodlar muhakkak soyut arayüz sınıfı tanımlanan sınıflarda da bulunmalıdır.
