...
<body>
	...
	*/
	...
	class UstAlan extends Tema{ // Hata kodu döndürür, çünkü soyut sınıf içerinde bulunan BodyAlani metodu, soyut sınıfdan türeyen UstAlan sınıfı içerisinde kullanılmamıştır.
