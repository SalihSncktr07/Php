...
<body>
	...
	*/
	...
	$Sonuc			=	str_word_count($Icerik, 0);
	
	echo $Sonuc . "<br /><br />";
	
	$IslemBir		=	str_word_count("Extra Eğitim - Volkan Alakent - A'dan Z'ye PHP Görsel Eğitim Seti", 1);
	...
	$IslemIki		=	str_word_count("Extra Eğitim - Volkan Alakent - A'dan Z'ye PHP Görsel Eğitim Seti", 2);
