...
<body>
	...
	*/
	...
	$Isimler		=	array("Bir" => "Volkan", "Iki" => "Hakan", "Uc" => "Onur");
	
	echo "<pre>";
	print_r($Isimler);
	echo "</pre>";
	
	array_push($Isimler, "Dort" => "Levent", "Bes" => "Serkan"); // HATA, array_unshift() veya array_push() metotları ile yeni eklenecek olan eleman veya elemanlara anahtar tayin etme işlemi yapılamaz.
