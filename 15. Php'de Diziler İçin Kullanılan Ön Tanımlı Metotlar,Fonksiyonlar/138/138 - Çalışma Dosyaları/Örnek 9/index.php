...
<body>
	...
	*/
	...
	$IsimlerBir		=	array("A1" => "Volkan", "A2" => "Hakan", "A3" => "Onur", "A4" => "Murat", "A5" => "Levent");
	$IsimlerIki		=	array("B1" => "Aslı", "B2" => "Banu", "B3" => "Derya");
	...
	$Sonuc			=	array_replace_recursive($IsimlerBir, $IsimlerIki);
