...
<body>
	...
	*/
	...
	$RenklerBir		=	array("A1" => "Siyah", "A2" => "Beyaz", "A3" => "Kırmızı", "A4" => "Sarı", "A5" => "Mavi", "A6" => "Gri", "A7" => "Bordo", "A8" => "Yeşil");
	$RenklerIki		=	array("B1" => "Pembe", "B2" => "Mavi", "B3" => "Eflatun", "B4" => "Beyaz", "B5" => "Lacivert");
	...
	$Sonuc 		=	array_diff_key($RenklerBir, $RenklerIki);
