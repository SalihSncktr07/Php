...
<body>
	...
	*/
	...
	$Isimler	=	array("Renk" => "Mavi", "Sehpa", "Arac" => "Gemi", "Televizyon", "Isim" => "Volkan", "YazilimDili" => "PHP", "Makas");
	...
	echo $Isimler[0] . "<br />";
	echo $Isimler["Arac"] . "<br />";
	echo $Isimler[1] . "<br />";
	echo $Isimler["Isim"] . "<br />";
	echo $Isimler["YazilimDili"] . "<br />";
	echo $Isimler[2];
