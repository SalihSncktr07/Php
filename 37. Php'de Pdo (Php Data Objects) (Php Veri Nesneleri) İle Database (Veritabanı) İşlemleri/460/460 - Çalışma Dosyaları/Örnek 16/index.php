...
<body>
	...
	*/
	...
	$Sorgu	=	$VeritabaniBaglantisi->exec("ALTER TABLE uyeler 
		ADD dogumtarihi smallint(4) NOT NULL AFTER telefon,
		ADD yoneticionaydurumu tinyint(1) NOT NULL,
		ADD sitemizineredenduydunuz varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL AFTER sehir,
		ADD ilk text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL FIRST
	");
		if($Sorgu !== false){
