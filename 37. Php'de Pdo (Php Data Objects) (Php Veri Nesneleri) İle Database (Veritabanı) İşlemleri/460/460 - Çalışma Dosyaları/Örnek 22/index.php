...
<body>
	...
	*/
	...
	$Sorgu	=	$VeritabaniBaglantisi->exec("ALTER TABLE uyeler 
		CHANGE ilk deneme int(10) UNSIGNED NOT NULL,
		CHANGE dogumtarihi dogdugunuzay varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
	");
		if($Sorgu !== false){
			echo "Sütunlar güncellendi";
		}else{
			echo "Sorgu Hatası";
		}
