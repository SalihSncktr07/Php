	...
	$Sorgu 	=	$VeritabaniBaglantisi->query("SHOW TABLES FROM extraegitim");
		if($Sorgu){
			foreach($Sorgu as $Tablolar){
				$SorguA		=	$VeritabaniBaglantisi->query("CHECK TABLE extraegitim." . $Tablolar[0]);
				$SorguB		=	$VeritabaniBaglantisi->query("ANALYZE TABLE extraegitim." . $Tablolar[0]);
				$SorguC		=	$VeritabaniBaglantisi->query("REPAIR TABLE extraegitim." . $Tablolar[0]);
				$SorguD		=	$VeritabaniBaglantisi->query("OPTIMIZE TABLE extraegitim." . $Tablolar[0]);
