...
<body>
	...
	*/
	...
	$Sorgu		=	$VeritabaniBaglantisi->query("SELECT isim AS KISIADI, beceriler AS KISIBECERILERI FROM kisiler");
		if($Sorgu){
			foreach($Sorgu as $Satirlar){
				echo "İSİM : " . $Satirlar["KISIADI"] . "<br />";
				echo "BECERİLER : " . $Satirlar["KISIBECERILERI"] . "<br /><br />";
			}
		}else{
			echo "Sorgu Hatası";
		}
