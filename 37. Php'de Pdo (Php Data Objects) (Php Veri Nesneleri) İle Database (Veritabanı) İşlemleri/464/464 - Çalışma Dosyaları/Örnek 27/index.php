...
<body>
	...
	*/
	...
	$Sorgu		=	$VeritabaniBaglantisi->query("SELECT * FROM kisiler");
		if($Sorgu){
			$SorguKaydi	=	$Sorgu->fetch(); // FETCH_BOTH (Varsayılan) | FETCH_ASSOC | FETCH_NUM | FETCH_OBJ
			echo "ID : " . $SorguKaydi["id"] . "<br />";
			echo "İSİM : " . $SorguKaydi["isim"] . "<br />";
			echo "YAŞ : " . $SorguKaydi["yas"] . "<br />";
			echo "BECERİLER : " . $SorguKaydi["beceriler"] . "<br />";
			echo "BECERİ SEVİYELERİ : " . $SorguKaydi["beceriseviyeleri"] . "<br /><br />";
		}else{
			echo "Sorgu Hatası";
		}
