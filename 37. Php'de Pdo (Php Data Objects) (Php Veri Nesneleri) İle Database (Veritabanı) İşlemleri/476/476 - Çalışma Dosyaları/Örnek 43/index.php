...
<body>
	...
	*/
	...
	$Ekle->bindParam(2, $GelenMail, PDO::PARAM_STR);
	$Ekle->bindParam(3, $GelenSifre, PDO::PARAM_STR);
	$Ekle->bindParam(4, $GelenTelefon, PDO::PARAM_STR);
	$Ekle->bindParam(5, $GelenYas, PDO::PARAM_INT);
	$Ekle->bindParam(6, $GelenCinsiyet, PDO::PARAM_STR);
	$Ekle->bindParam(7, $GelenSehir, PDO::PARAM_STR);
	$Ekle->execute();
		if($Ekle){
			echo "Kayıt Eklendi";
		}else{
