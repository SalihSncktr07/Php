...
<body>
	...
	*/
	...
	$Guncelle->bindParam(":GelenIsim", $GelenIsim, PDO::PARAM_STR);
	$Guncelle->bindParam(":GelenTelefon", $GelenTelefon, PDO::PARAM_STR);
	$Guncelle->bindParam(":GelenYas", $GelenYas, PDO::PARAM_INT);
	$Guncelle->bindParam(":GelenID", $GelenID, PDO::PARAM_INT);
	$Guncelle->execute();
		if($Guncelle){
