...
<body>
	...
	*/
	...
	$Ekle->execute([':KullaniciIsimSoyisim' => 'Ömer Çelik', ':KullaniciEmail' => 'omer@yandex.com', ':KullaniciSifre' => '1234', ':KullaniciTelefon' => '05320000000', ':KullaniciYas' => '33', ':KullaniciCinsiyet' => 'Erkek', ':KullaniciSehir' => 'Uşak']);
		if($Ekle){
			echo "Kayıt Eklendi";
		}else{
			echo "Sorgu Hatası";
