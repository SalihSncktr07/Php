...
<body>
	...
	*/
	...
	$GelenIsim		=	'Ömer Çelik';
	$GelenMail		=	'omer@yandex.com';
	$GelenSifre		=	'1234';
	$GelenTelefon	=	'05320000000';
	$GelenYas		=	33;
	$GelenCinsiyet	=	'Erkek';
	$GelenSehir		=	'Uşak';
	
	$Ekle		=	$VeritabaniBaglantisi->prepare("INSERT INTO uyeler (adisoyadi, emailadresi, sifre, telefon, yas, cinsiyet, sehir) values (:KullaniciIsimSoyisim, :KullaniciEmail, :KullaniciSifre, :KullaniciTelefon, :KullaniciYas, :KullaniciCinsiyet, :KullaniciSehir)");
	$Ekle->bindValue(":KullaniciIsimSoyisim", $GelenIsim, PDO::PARAM_STR);
	$Ekle->bindValue(":KullaniciEmail", $GelenMail, PDO::PARAM_STR);
	$Ekle->bindValue(":KullaniciSifre", $GelenSifre, PDO::PARAM_STR);
	$Ekle->bindValue(":KullaniciTelefon", $GelenTelefon, PDO::PARAM_STR);
	$Ekle->bindValue(":KullaniciYas", $GelenYas, PDO::PARAM_INT);
	$Ekle->bindValue(":KullaniciCinsiyet", $GelenCinsiyet, PDO::PARAM_STR);
	$Ekle->bindValue(":KullaniciSehir", $GelenSehir, PDO::PARAM_STR);
	$Ekle->execute();
		if($Ekle){
			echo "Kayıt Eklendi";
		}else{
