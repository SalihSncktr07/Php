...
<body>
	...
	*/
	...
	$Ekle->bindParam(":KullaniciIsimSoyisim", $GelenIsim, PDO::PARAM_STR);
	$Ekle->bindParam(":KullaniciEmail", $GelenMail, PDO::PARAM_STR);
	$Ekle->bindParam(":KullaniciSifre", $GelenSifre, PDO::PARAM_STR);
	$Ekle->bindParam(":KullaniciTelefon", $GelenTelefon, PDO::PARAM_STR);
	$Ekle->bindParam(":KullaniciYas", $GelenYas, PDO::PARAM_INT);
	$Ekle->bindParam(":KullaniciCinsiyet", $GelenCinsiyet, PDO::PARAM_STR);
	$Ekle->bindParam(":KullaniciSehir", $GelenSehir, PDO::PARAM_STR);
	$Ekle->execute();
		if($Ekle){
			echo "Kayıt Eklendi";
		}else{
