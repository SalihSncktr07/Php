...
<body>
	...
	*/
	...
	$Sorgu		=	$VeritabaniBaglantisi->prepare("SELECT * FROM uyeler", array(PDO::FETCH_OBJ)); // array(PDO::FETCH_OBJ) yazısa dahi veriler sanki array(PDO::FETCH_BOTH) varmış gibi alınmalıdır.
	$Sorgu->execute();
		if($Sorgu){
