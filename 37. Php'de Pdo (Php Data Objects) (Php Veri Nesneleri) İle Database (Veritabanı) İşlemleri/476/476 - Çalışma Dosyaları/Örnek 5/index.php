...
<body>
	...
	*/
	...
	$Sorgu		=	$VeritabaniBaglantisi->prepare("SELECT * FROM uyeler", array(PDO::FETCH_ASSOC)); // array(PDO::FETCH_ASSOC) yazısa dahi veriler sanki array(PDO::FETCH_BOTH) varmış gibi alınmalıdır.
	$Sorgu->execute();
		if($Sorgu){
