...
<body>
	...
	*/
	...
	$Ekle->execute([':KullaniciIsimSoyisim' => $GelenIsim, ':KullaniciEmail' => $GelenMail, ':KullaniciSifre' => $GelenSifre, ':KullaniciTelefon' => $GelenTelefon, ':KullaniciYas' => $GelenYas, ':KullaniciCinsiyet' => $GelenCinsiyet, ':KullaniciSehir' => $GelenSehir]);
		if($Ekle){
			echo "Kayıt Eklendi";
		}else{
			echo "Sorgu Hatası";
