...
<body>
	...
	*/
	...
	$Guncelle		=	$VeritabaniBaglantisi->prepare("UPDATE uyeler SET adisoyadi=?, telefon=?, yas=? WHERE id=?");
	$Guncelle->bindValue(1, $GelenIsim, PDO::PARAM_STR);
	$Guncelle->bindValue(2, $GelenTelefon, PDO::PARAM_STR);
	$Guncelle->bindValue(3, $GelenYas, PDO::PARAM_INT);
	$Guncelle->bindValue(4, $GelenID, PDO::PARAM_INT);
	$Guncelle->execute();
		if($Guncelle){
