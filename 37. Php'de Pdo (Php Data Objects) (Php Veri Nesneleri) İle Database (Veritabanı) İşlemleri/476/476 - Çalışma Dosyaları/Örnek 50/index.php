...
<body>
	...
	*/
	...
	$Guncelle->bindParam(1, $GelenIsim, PDO::PARAM_STR);
	$Guncelle->bindParam(2, $GelenTelefon, PDO::PARAM_STR);
	$Guncelle->bindParam(3, $GelenYas, PDO::PARAM_INT);
	$Guncelle->bindParam(4, $GelenID, PDO::PARAM_INT);
	$Guncelle->execute();
		if($Guncelle){
