...
<body>
	...
	*/
	...
	$Ekle		=	$VeritabaniBaglantisi->prepare("INSERT INTO uyeler (adisoyadi, emailadresi, sifre, telefon, yas, cinsiyet, sehir) values ('Ömer Çelik', 'omer@yandex.com', '1234', '05320000000', '33', 'Erkek', 'Uşak')");
	$Ekle->execute();
		if($Ekle){
			echo "Kayıt Eklendi";
		}else{
