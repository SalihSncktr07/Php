...
<body>
	...
	*/
	...
	$Guncelle->bindParam(":AranaDeger", $AranaDeger, PDO::PARAM_STR);
	$Guncelle->bindParam(":DegisecekDeger", $DegisenDeger, PDO::PARAM_STR);
	$Guncelle->bindParam(":IdDegeri", $IdDegeri, PDO::PARAM_INT);
	$Guncelle->execute();
		if($Guncelle){
