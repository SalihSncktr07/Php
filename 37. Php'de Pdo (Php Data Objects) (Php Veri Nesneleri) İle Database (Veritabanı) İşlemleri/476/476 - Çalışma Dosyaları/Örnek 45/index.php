...
<body>
	...
	*/
	...
	$Ekle->bindValue(1, $GelenIsim, PDO::PARAM_STR);
	$Ekle->bindValue(2, $GelenMail, PDO::PARAM_STR);
	$Ekle->bindValue(3, $GelenSifre, PDO::PARAM_STR);
	$Ekle->bindValue(4, $GelenTelefon, PDO::PARAM_STR);
	$Ekle->bindValue(5, $GelenYas, PDO::PARAM_INT);
	$Ekle->bindValue(6, $GelenCinsiyet, PDO::PARAM_STR);
	$Ekle->bindValue(7, $GelenSehir, PDO::PARAM_STR);
	$Ekle->execute();
		if($Ekle){
			echo "Kayıt Eklendi";
		}else{
