...
<body>
	...
	*/
	...
	$AranaDeger		=	"volkanalakent";
	$DegisenDeger	=	"extraegitim";
	$IdDegeri		=	5;
	
	$Guncelle		=	$VeritabaniBaglantisi->prepare("UPDATE uyeler SET emailadresi=REPLACE(emailadresi, ?, ?) WHERE id>?");
	$Guncelle->bindValue(1, $AranaDeger, PDO::PARAM_STR);
	$Guncelle->bindValue(2, $DegisenDeger, PDO::PARAM_STR);
	$Guncelle->bindValue(3, $IdDegeri, PDO::PARAM_INT);
	$Guncelle->execute();
		if($Guncelle){
