...
<body>
	...
	*/
	...
	$AranaDeger		=	"extraegitim";
	$DegisenDeger	=	"volkanalakent";
	$IdDegeri		=	5;
	
	$Guncelle		=	$VeritabaniBaglantisi->prepare("UPDATE uyeler SET emailadresi=REPLACE(emailadresi, :AranaDeger, :DegisecekDeger) WHERE id>:IdDegeri");
	$Guncelle->bindValue(":AranaDeger", $AranaDeger, PDO::PARAM_STR);
	$Guncelle->bindValue(":DegisecekDeger", $DegisenDeger, PDO::PARAM_STR);
	$Guncelle->bindValue(":IdDegeri", $IdDegeri, PDO::PARAM_INT);
	$Guncelle->execute();
		if($Guncelle){
