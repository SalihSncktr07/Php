...
<body>
	...
	*/
	...
	$Sorgu		=	$VeritabaniBaglantisi->query("SELECT sehir, SUM(siparistoplamtutarlari) AS ToplamTutar FROM kayitlar GROUP BY sehir HAVING ToplamTutar>0", PDO::FETCH_ASSOC);
		if($Sorgu){
