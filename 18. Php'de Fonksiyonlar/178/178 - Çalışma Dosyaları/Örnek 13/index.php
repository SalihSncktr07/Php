...
<body>
	...
	*/
	...
	echo "Fonkisyon 1. Defa Çağrıldı : <br />";
	Saydir();
	echo "<br />Fonkisyon 2. Defa Çağrıldı : <br />";
	Saydir();
	echo "<br />Fonkisyon 3. Defa Çağrıldı : <br />";
	Saydir();
	echo "<br />Fonkisyon 4. Defa Çağrıldı : <br />";
	Saydir();
	echo "<br />Fonkisyon 5. Defa Çağrıldı : <br />";
	Saydir();
