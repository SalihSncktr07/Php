...
<body>
	...
	*/
	...
	function Bilgiler(){
		...
		return "Fonksiyona Gelen Parametre Sayısı : " . $GelenParametreSayisi;
	}
	
	$Sonuc	=	Bilgiler("Volkan", "Alakent", "İstanbul", "Bilgisayar programlama ve yazılım geliştirme uzamanı", 38, "Erkek", "info@extraegitim.com", "https://www.extraegitim.com");
