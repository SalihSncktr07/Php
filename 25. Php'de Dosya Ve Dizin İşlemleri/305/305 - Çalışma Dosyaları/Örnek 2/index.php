...
<body>
	...
	*/
	...
	if($DosyayiAc){
		...
		echo $Dosya . " isimli dosyanın açma işlemi sırasında beklenmeyen bir hata oluştu.<br />";
	}
	
	$DosyayiKapat	=	fclose($DosyayiAc);
	
	if($DosyayiKapat==1){
		echo $Dosya . " isimli dosya başarıyla kapandı.";
	}else{
		echo $Dosya . " isimli dosyanın kapatma işlemi sırasında beklenmeyen bir hata oluştu.";
	}
